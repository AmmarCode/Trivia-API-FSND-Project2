...
----------------
#### Getting Started 
- Based URL: At present this app is only run locally and is not hosted as a base URL. The backend app is hosted at the default, http:/127.0.0.1:5000/ , which is set as a proxy in the frontend configeration.
